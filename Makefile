...
.PHONY: all
all: manifests generate fmt vet docker-build
...
.PHONY: chainsaw
chainsaw: $(CHAINSAW) ## Download controller-gen locally if necessary.
$(CHAINSAW): $(LOCALBIN)
...
gowrap: $(GOWRAP)
$(GOWRAP):
	GOBIN=$(GOBIN) go install github.com/hexdigest/gowrap/cmd/gowrap@latest
